...
public class ChatLieuRepository {
    ...
    final String Select_All_CL = "Select * from chatlieu";
    final String InsertCL = "Insert into chatlieu(chatLieuThan, chatlieuDe) values(?, ?)";
    final String updateCL = "Update chatlieu set chatlieuDe = ? , chatLieuthan=? where id = ?";
    final String DeleteCL = "Delete from chatlieu where id = ?";
    final String Check_CLThan = "select count(*) from chatlieu where chatLieuThan=?";
    final String Check_CLDe = "select count(*) from chatlieu where chatLieuDe=?";
    final String Check_CL = "select count(*) from chatlieu where chatLieuDe=? and chatlieuthan = ?";
    final String listThan = "select distinct chatLieuthan from chatlieu";
    final String listDe = "select distinct chatLieude from chatlieu";
    final String findCL = "select * from chatLieu where chatlieuthan = ? and chatlieude = ?";
    final String findById = "select * from chatlieu where Id=?";
    final String findByMa = "select * from chatlieu where maChatLieu=?";
